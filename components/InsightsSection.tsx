...
const weeklyData = [
  ...
  { day: "Thu", incoming: 54, answered: 40, experts: 15 },
  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row gap-6 overflow-auto">
        ...
        <div className="lg:w-1/4 overflow-hidden col-span-1 lg:col-span-3 bg-white py-8 rounded-3xl border-[0.5px] drop-shadow-sm border-[0px 5px 22px 0px #0000000A]">
          <div className="flex items-center gap-2 mb-6 px-6">
            <svg
              width="10"
              height="10"
          ...
          <div className="flex items-center gap-4  border-t-[1px] mx-2 pt-6">
        ...
        <div
          className="lg:w-[260px] overflow-hidden col-span-1 lg:col-span-2 bg-[#15B79E] border-[0px 5px 22px 0px #0000000A] drop-shadow-sm p-6 rounded-3xl text-white"
          style={{
